...
class RunImporter():
    ...
    def _import_run(self, dst_exp_name, input_dir, dst_notebook_dir):
        ...
        run = self.mlflow_client.create_run(experiment_id=exp.experiment_id, start_time=src_run_dct["info"]["start_time"])
        ...
        try:
            ...
            self.mlflow_client.set_terminated(run_id, src_run_dct["info"]["status"], src_run_dct["info"]["end_time"])
